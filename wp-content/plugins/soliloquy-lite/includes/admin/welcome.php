...
class Soliloquy_Welcome {
	...
	public static function welcome_text() {
		...
		$welcome_text = ( self::is_new_install() )
			? esc_html__( 'Thank you for installing Soliloquy Lite! soliloquy provides great slider features for your WordPress site!', 'soliloquy' )
			: esc_html__( 'Thank you for updating! Soliloquy Lite %s has many recent improvements that you will enjoy.', 'soliloquy' );
...
<div class="soliloquy-welcome-wrap soliloquy-help">
		...
		<div class="soliloquy-get-started-section">
			...
			<div class="soliloquy-admin-get-started-banner bottom">
				...
				<div class="banner-button">
					<a target="_blank"
						href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( false, 'getstartedtab', 'getsoliloquynowbutton' ) ); ?>"
		...
		<div class="soliloquy-get-started-main">
			...
			<div class="soliloquy-get-started-panel">
				...
				<div class="wraps upgrade-wrap">
					...
					<a target="_blank"
						href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( false, 'upgradesoliloquytab', 'upgradetosoliloquyprobutton' ) ); ?>"
				...
				<div class="upgrade-list">
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/carousel/', 'upgradesoliloquytab', 'carouseladdon', '' ) ); ?>">
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/thumbnails/', 'upgradesoliloquytab', 'thumbnailaddon', '' ) ); ?>">
								<div class="feature-icon">
									<img
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/instagram/', 'upgradesoliloquytab', 'instagramaddon', '' ) ); ?>">
								<div class="feature-icon">
									<img
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/pdf/', 'upgradesoliloquytab', 'pdfaddon', '' ) ); ?>">
								<div class="feature-icon">
									<img
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/schedule/', 'upgradesoliloquytab', 'socialaddon', '' ) ); ?>">
								<div class="feature-icon">
									<img
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/dynamic/', 'upgradesoliloquytab', 'imageproofing', '' ) ); ?>">
								<div class="feature-icon">
									<img
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/woocommerce-addon/', 'upgradesoliloquytab', 'ecommerce', '' ) ); ?>">
								<div class="feature-icon">
					...
					<div>
						<div class="interior">
							<a
								href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/addons/featured-content/', 'upgradesoliloquytab', 'featuredcontent', '' ) ); ?>">
								<div class="feature-icon">
									<img
	...
	<div class="lionsher-partners">
		<div class="lionsher-partners-main">
			...
			<div>
				...
				<p class="lionsher-partner-excerpt"><?php echo esc_html( $plugin['description'] ); ?>
				</p>
			</div>
		</div>
		<div class="lionsher-partners-footer">
			...
			<div class="lionsher-partners-install-wrap">
				<a href="#" target="_blank"
					...
					data-url="<?php echo esc_url_raw( $plugin['url'] ); ?>"
					data-basename="<?php echo esc_attr( $plugin['basename'] ); ?>">Install Plugin</a>
		...
		<div class="lionsher-partners-footer">
			...
			<div class="lionsher-partners-install-wrap">
				<a href="#" target="_blank"
					...
					data-url="<?php echo esc_url_raw( $plugin['url'] ); ?>"
					data-basename="<?php echo esc_attr( $plugin['basename'] ); ?>">Deactivate</a>
				<span class="spinner lionsher-gallery-spinner"></span>
			</div>
		</div>
	</div>
	...
	<div class="lionsher-partners">
		<div class="lionsher-partners-main">
			<div>
				<img src="<?php echo esc_html( $plugin['icon'] ); ?>" width="64px" />
			</div>
			<div>
				<h3><?php echo esc_html( $plugin['name'] ); ?></h3>
				<p class="lionsher-partner-excerpt"><?php echo esc_html( $plugin['description'] ); ?>
		...
		<div class="lionsher-partners-footer">
			...
			<div class="lionsher-partners-install-wrap">
				<a href="#" target="_blank"
					...
					data-url="<?php echo esc_url_raw( $plugin['url'] ); ?>"
					data-basename="<?php echo esc_attr( $plugin['basename'] ); ?>">Activate</a>
				<span class="spinner lionsher-gallery-spinner"></span>
			</div>
		</div>
	</div>
