...
class Soliloquy_Media_Lite {
	...
	public function do_media_upload_form( $width, $height ) {
		...
		<span class="max-upload-size"><?php printf( __( 'Maximum upload file size: %1$d%2$s.', 'soliloquy' ), esc_html( $this->get_upload_size_unit( $sizes ) ), esc_html( $sizes[ $this->get_upload_size_unit( $sizes, 'unit' ) ] ) ); ?></span>
		<?php
